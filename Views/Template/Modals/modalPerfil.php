<!-- Modal -->
<div class="modal fade modalFormPerfil" id="modalFormPerfil" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form id="formPerfil" name="formPerfil" class="form-horizontal">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="txtIdentificacion" name="txtIdentificacion" value="<?=$_SESSION['userData']['cedula'];?>" required="">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="email" class="form-control valid validEmail" id="txtEmail" name="txtEmail"  value="<?=$_SESSION['userData']['email'];?>" required="" readonly disable>
                </div>
              </div>
             </div>
             <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  <label for="txtPasswordConfirm">Confirma Password</label>
